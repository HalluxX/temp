        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20 sustainability-impact-content mt-10">
          <div className="text-sm col-span-1">
            <div className="font-bold">
              As the transition to a reduced-carbon and digital future gathers pace, we recognize our unique and essential position as North America’s largest employer of craft labor. HomeMax operating companies have the expertise and capabilities to support and accelerate the Energy Transition.
            </div>
            <div className="mt-10">
              In 2021, HomeMax Services acquired Blattner Company, one of the largest and leading utility-scale renewable energy infrastructure solutions providers in the United States to enhance our role in connecting people to renewable energy sources. Blattner spans the United States and operates in the main sectors of wind, solar, and energy storage, bringing renewable energy expertise to the HomeMax family of companies.
            </div>
          </div>
